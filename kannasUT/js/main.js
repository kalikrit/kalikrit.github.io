...
let geography_chart = new Chart(GEOGRAPHY, {
    type: 'doughnut',
	data: {
		labels: ["Ахтубинск", "Благовещенск", "Всеволжск","Выборг", "Заполярный","Коряжма","Кострома","Красково","Москва","Мурманск","Нелидово","Пермь","Псков","Пушкин","Самара","Санкт-Петербург","Тихвин","Тосно","Чехов","Ярославль"],
        datasets: [{
            data: [1,1,1,2,1,1,1,1,8,1,1,1,1,2,1,35,1,2,1,1],
