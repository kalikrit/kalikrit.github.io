...
let geography_chart = new Chart(GEOGRAPHY, {
    type: 'doughnut',
	data: {
		labels: ['Благовещенск', 'Выборг', 'Вязьма', 'Железнодорожный','Заполярный', 'Зеленоград', 'Казань', 'Ломоносов', 'Москва','Мурманск', 'Олонец', 'Петергоф', 'Петрозаводск', 'Псков','Самара', 'Санкт-Петербург', 'Сосновый Бор', 'Тихвин', 'Тюмень','Чехов', 'Ярославль'],
        datasets: [{
            data: [1,2,1,1,1,2,1,1,10,2,1,2,1,1,1,41,1,1,2,1,2],
			backgroundColor: [
			"#4e2400",	
			"#51574a",
			"#447c69",
