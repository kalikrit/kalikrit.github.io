	...
	data: {
		...
		datasets: [
			...
			},			
			{
				...
				borderColor: "#515700",
				data: [1235, 19386, 18472, 11562, 18064, 15973, 11431, 10466, 2998]
			},
			{
				label: "спорт",
				fill: true,
			...
			},
			{
				...
				borderColor: "#c94a00",
				data: [0,670,12028,2409,2159,11110,10959,3686,4053]
			},
			{
				label: "сладости",
				fill: true,
				...
				borderColor: "#447c00",
				data: [1931, 4784, 3612, 1471, 2717, 2793, 3391, 3041, 1078]
			}
		]
	}
});